...
const StartEaring = () => {
	return (
		<div className='flex gap-6 px-4 flex-col items-center justify-center h-[200px] w-full opacity-90 '>
			...
			<div className=' flex items-center justify-center w-full md:w-[20%]'>
				<Link
					...
					className='w-full py-3 mx-auto font-semibold text-center text-gray-100 bg-green-700 rounded '
				>
